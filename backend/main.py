...
from backend.config import VIDEO_LIBRARY_PATH
...
async def lifespan(app: FastAPI):
    ...
    if VIDEO_LIBRARY_PATH:
        logger.info(f"Library path configured: {VIDEO_LIBRARY_PATH}")
        manager.initial_scan(VIDEO_LIBRARY_PATH)
